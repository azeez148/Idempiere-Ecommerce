				...
				[
						...
						//	ProductCategoryService.fetchAllProductCategories();
						    ...
						    function fetchAllProducts() {
						    	AdminProductService.fetchAllProducts().then(
										function(response) {
						...
						/*	$scope.filteredItems = [];
							...
							$("#imageupload").on('change', function () {
								$scope.imageUrls=[];
							     ...
							     if (extn == "gif" || extn == "png" || extn == "jpg" || extn == "jpeg") {
							         if (typeof (FileReader) != "undefined") {
							             ...
							             for (var i = 0; i < countFiles; i++) {
							                 ...
							                 //var selectedFile = $(this)[0].files[i];
							     ...
							     angular.forEach($scope.imageUrls,
											function(images) {
							...
							function getBase64(selectedFile) {
							    selectedFile.convertToBase64(function(base64){
						             console.log("string image "+i+"th Image "+base64);
						             $scope.imageUrls.push(base64);
						        });
