						...
						function($parse, modalConfig) {
							...
							return {
								...
								link : function(scope, elm, attrs) {
									var opts = angular.extend({}, modalConfig,
									...
									if (opts.backdrop && !backdropEl) {
										backdropEl = angular
												.element('<div class="modal-backdrop"></div>');
									...
									function close() {
										...
										if (opts.backdrop) {
											backdropEl.css('display', 'none')
													.removeClass('in');
											backdropEl.unbind('click',
													clickClose);
										}
										elm.css('display', 'none').removeClass(
												'in');
									...
									function open() {
										...
										if (opts.backdrop) {
											...
											if (opts.backdrop != "static") {
												backdropEl.bind('click',
														clickClose);
											}
										}
										elm.css('display', 'block').addClass(
												'in');
