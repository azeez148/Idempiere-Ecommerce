...
<div class="box" ng-init="getAllUsers()">
...
<h5>Total Number of Users : {{itemsSize}}</h5>
				
	<div class="alert alert-success" ng-show="updateSuccessMsg != null">
				<span class="glyphicon glyphicon-ok-circle" aria-hidden="true"></span>
				{{updateSuccessMsg}}
				</div>
						<div class="alert alert-danger" ng-show="updateErrorMsg != null">
...
Deactivate</span>
								...
								<a class="btn btn-info btn-xs" data-toggle="modal" ng-click="openContactModal(item)"><i class="fa fa-envelope-o" aria-hidden="true"></i>Contact User</a>
			...
			<div class="modal-dialog" role="document">
				<div class="modal-content">
					...
					<div class="modal-footer text-center">
						...
						<button type="button" class="btn btn-primary" ng-click="updateVendorStatus(user)">Save changes</button>
					</div>
				</div>
			</div>
		</div>
