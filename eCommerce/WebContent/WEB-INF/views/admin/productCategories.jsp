...
<div id="content">
   ...
   <div><img src="http://mycodingtricks.com/wp-content/uploads/2015/05/Preloader_1.gif"/></div>
		...
		<div class="col-sm-10" ng-init="getAllProductCategories()">
 ...
 -->
					...
					<a class="btn btn-primary create-button" data-toggle="modal"
						ng-click="openCreateModal()"> <i class="fa fa-plus-circle"
						aria-hidden="true"></i>Create Category
					</a>
			...
			<div class="box">
				...
				<h2>
					<span class="text-center">Manage Product Categories</span>
				</h2>
<br/>
				<h5>Total number of items : {{itemsSize}}</h5>
					 ...
					 <label class='control-label' for="vendor">Items Per Page:</label>
							...
							<td colspan="12">
								...
								<div class="pagination pull-right">
									...
									<input type="text" class="form-control"
											ng-model="pageNumber" id="pageNumber">
									</li>
 ...
 -->
				<div class="table-responsive">
					...
					<table
						class="table table-sm table-striped table-condensed table-hover table-bordered">
						...
						<thead>
							...
							<tr>
								...
								<th class="name" custom-sort order="'name'" sort="sort">Category
									Name&nbsp;</th>
								<th class="description" custom-sort order="'description'"
									sort="sort">Parent Category Name&nbsp;</th>
 ...
 -->
      ...
      ng-model="data.selectedOption" class="form-control" ng-change="updateItemsPerPage(data.selectedOption)"></select></td> 
						...
						<tbody>
							<tr
								...
								<td>
									...
									<h6>
										<span ng-if="item.isActive == 'Y'" class="label label-success status-active">Active</span>
									</h6>
									<h6>
										<span ng-if="item.isActive == 'N'" class="label label-danger status-inactive">InActive</span>
									</h6>

								</td>

								<!-- data-target="#blockUser" -->
								<td><a class="btn btn-info btn-xs update-button" data-toggle="modal"
									ng-click="openUpdateModal(item)"><i
										class="fa fa-pencil-square-o" aria-hidden="true"></i>Update</a> <a
									class="btn btn-danger btn-xs status-button" data-toggle="modal"
									ng-click="openModal(item)"><span
										ng-if="item.isActive == 'Y'"><i class="fa fa-eye-slash"
											aria-hidden="true"></i> Deactivate</span> <span
										ng-if="item.isActive == 'N'"><i class="fa fa-eye"
											aria-hidden="true"></i> Activate</span> </a> <!-- <a class="btn btn-info btn-xs" data-toggle="modal" ng-click="openContactModal(item)">Contact Category</a> -->
		...
		<div class="modal fade" id="createCategory" tabindex="-1"
			role="dialog" aria-labelledby="myModalLabel" ng-init="getVendors()">
					...
					<div class="modal-body">
						...
						<form name="createCategoryForm">
							...
							<div class="alert alert-success"
								ng-show="createdSuccessMsg != null">{{createdSuccessMsg}}
							</div>
							<div class="alert alert-danger" ng-show="createdErrorMsg != null">
							...
							<div class="alert alert-danger"
								ng-show="passwordErrorMsg != null">{{passwordErrorMsg}}</div>
							<div class="alert alert-danger" ng-show="emailErrorMsg != null">
								{{emailErrorMsg}}</div>
							...
							<div class="row">
								<div class="col-sm-4">
									<div class="form-group required">
										...
										<input type="text" class="form-control"
											ng-model="category.name" id="name" required="required">
									</div>
								</div>
								<div class="col-sm-4">
							...
							<div class="row">
								<div class="col-sm-12">
									<div class="form-group">
										<label class='control-label' for="vendor">Select
											Vendor</label>


     <select multiple ng-multiple="true" ng-model="selected" ng-options="vendor.userName for vendor in vendors" class="form-control"></select>
					...
					<div class="modal-footer text-center">
						...
						<button type="button" class="btn btn-primary"
							ng-click="submitCategory(category)">
					...
					<div class="modal-body">
						...
						<form name="createCategoryForm">
							...
							<div class="row">
								...
								<div class="col-sm-6">
									<div class="form-group">
										<label class='control-label' for="country">Parent Category
										</label>



										<select ng-options="category.name for category in categories" ng-model="selectedCategory" class="form-control"></select>
								...
								<div class="col-sm-12">
									<div class="form-group">
										<label class='control-label' for="vendor">Select
											Vendor</label>
     <select ng-model="selectedVendors"  multiple ng-multiple="true" ng-options="vendor.userName for vendor in vendors" class="form-control"></select>
		...
		<div class="modal fade" id="blockCategory" tabindex="-1" role="dialog"
			...
			<div class="modal-dialog" role="document">
				<div class="modal-content">
					...
					<div class="modal-body">
						<h3>
							Do you want to <span ng-if="category.isActive == 'Y'">De-Activate
							</span><span ng-if="category.isActive == 'N'">Activate </span>{{category.name}}
						</h3>
					...
					<div class="modal-footer text-center">
						<button type="button" class="btn btn-default" data-dismiss="modal">Close</button>
						<button type="button" class="btn btn-primary"
							ng-click="updateCategoryStatus(category)">
